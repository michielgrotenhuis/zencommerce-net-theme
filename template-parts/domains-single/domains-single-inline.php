    ...
    <div class="layout-container">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="relative grid md:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="hidden md:block absolute top-10 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-blue-300 via-blue-200 to-blue-300 dark:from-blue-700 dark:via-blue-800 dark:to-blue-700 z-0"></div>
                    ...
                    <div class="relative text-center group">
                        ...
                        <div class="relative mb-6 z-10">
                            ...
                            <div class="w-20 h-20 mx-auto bg-white dark:bg-gray-800 rounded-full shadow-lg border-4 border-blue-200 dark:border-blue-800 flex items-center justify-center group-hover:border-blue-400 dark:group-hover:border-blue-600 transition-colors duration-300">
                                ...
                                <div class="absolute -top-2 -right-2 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg z-20">
