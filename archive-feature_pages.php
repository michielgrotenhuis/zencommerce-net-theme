            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <a href="<?php echo home_url('/features/store-building/'); ?>" class="feature-cta-button mt-4">
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <a href="<?php echo home_url('/features/payment-methods/'); ?>" class="feature-cta-button mt-4">
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <a href="<?php echo home_url('/features/marketing-seo/'); ?>" class="feature-cta-button mt-4">
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <a href="<?php echo home_url('/features/inventory-management/'); ?>" class="feature-cta-button mt-4">
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Graphics & Appearance That Converts</h3>
                        <p class="text-gray-600 mb-6">
                            Make your store look like a million-dollar brand. Our advanced design tools and professional templates help you create stunning visuals that turn visitors into customers.
                        </p>
                        <div class="space-y-3">
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="feature-benefit-item">
                                ...
                                <span>Custom branding tools</span>
                            </div>
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span>Advanced image optimization</span>
                            </div>
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span>Responsive design guarantee</span>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <div class="space-y-2 text-sm text-gray-700">
                            <div class="flex justify-between">
                                <span>Brand recognition boost:</span>
                                <span class="font-semibold">85% increase</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold">3x faster</span>
                            </div>
                        </div>
                        <a href="<?php echo home_url('/features/graphics-appearance/'); ?>" class="feature-cta-button mt-4">
                            <span>Learn More About Design</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Integrations That Actually Work</h3>
                        <p class="text-gray-600 mb-6">
                            Connect your store to everything you already use. Our 200+ integrations work flawlessly with your existing tools, saving you time and preventing data sync nightmares.
                        </p>
                        <div class="space-y-3">
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <div class="space-y-2 text-sm text-gray-700">
                            ...
                            <div class="flex justify-between">
                                <span>Data accuracy improved:</span>
                                <span class="font-semibold">99.9%</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Technical support saved:</span>
                                <span class="font-semibold">$2,400/month</span>
                            </div>
                        </div>
                        <a href="<?php echo home_url('/features/integrations/'); ?>" class="feature-cta-button mt-4">
            ...
            <div class="feature-deep-card mb-12">
                <div class="grid lg:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Social Media That Sells</h3>
                        <p class="text-gray-600 mb-6">
                            Turn your social media into a sales machine. Our built-in social commerce tools help you sell directly on Instagram, Facebook, TikTok, and more - all managed from one dashboard.
                        </p>
                        <div class="space-y-3">
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span>Instagram & Facebook Shop integration</span>
                            </div>
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span>TikTok Shopping integration</span>
                            </div>
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <div class="space-y-2 text-sm text-gray-700">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold">340% increase</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Content creation time:</span>
                                <span class="font-semibold">75% reduction</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Customer engagement:</span>
                                <span class="font-semibold">2.8x higher</span>
                            </div>
                        </div>
                        <a href="<?php echo home_url('/features/social-media/'); ?>" class="feature-cta-button mt-4">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="feature-benefit-item">
                                ...
                                <span>App-like shopping experience</span>
                            </div>
                            <div class="feature-benefit-item">
                                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span>Offline browsing capabilities</span>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-100 rounded-lg p-6">
